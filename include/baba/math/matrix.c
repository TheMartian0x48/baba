...
inline void matrix2i_copy(const Matrix2i* a, Matrix2i* result)
{
    ...
    tmat.x10      = a->x10;
    tmat.x11      = a->x11;
    mem_copy(result, &tmat, sizeof(Matrix2i));
}
...
inline void matrix2f_multiply(const Matrix2f* a, const Matrix2f* b, Matrix2f* result)
{
    ...
    assert(result != nullptr && "matrix result cannot be null");
    Matrix2f tmat = {0};
    tmat.x00      = a->x00 * b->x00 + a->x01 * b->x10;
    tmat.x01      = a->x00 * b->x01 + a->x01 * b->x11;
    tmat.x10      = a->x10 * b->x00 + a->x11 * b->x10;
    tmat.x11      = a->x10 * b->x00 + a->x11 * b->x10;
    mem_copy(result, &tmat, sizeof(Matrix2f));
}
...
inline void matrix3i_multiply(const Matrix3i* a, const Matrix3i* b, Matrix3i* result)
{
    ...
    assert(result != nullptr && "matrix result cannot be null");
    Matrix3i tmat = {0};
    tmat.x00      = a->x00 * b->x00 + a->x01 * b->x10 + a->x02 * b->x20;
    tmat.x01      = a->x00 * b->x01 + a->x01 * b->x11 + a->x02 * b->x21;
    tmat.x02      = a->x00 * b->x02 + a->x01 * b->x12 + a->x02 * b->x22;
    tmat.x10      = a->x10 * b->x00 + a->x11 * b->x10 + a->x12 * b->x20;
    tmat.x11      = a->x10 * b->x01 + a->x11 * b->x11 + a->x12 * b->x21;
    tmat.x12      = a->x10 * b->x02 + a->x11 * b->x12 + a->x12 * b->x22;
    tmat.x20      = a->x20 * b->x00 + a->x21 * b->x10 + a->x22 * b->x20;
    tmat.x21      = a->x20 * b->x01 + a->x21 * b->x11 + a->x22 * b->x21;
    tmat.x22      = a->x20 * b->x02 + a->x21 * b->x12 + a->x22 * b->x22;
    mem_copy(result, &tmat, sizeof(Matrix3i));
}
...
inline void matrix3f_multiply(const Matrix3f* a, const Matrix3f* b, Matrix3f* result)
{
    ...
    tmat.x21      = a->x20 * b->x01 + a->x21 * b->x11 + a->x22 * b->x21;
    tmat.x22      = a->x20 * b->x02 + a->x21 * b->x12 + a->x22 * b->x22;
    mem_copy(result, &tmat, sizeof(Matrix3f));
}
...
inline void matrix4i_multiply(const Matrix4i* a, const Matrix4i* b, Matrix4i* result)
{
    ...
    mem_copy(result, &tmat, sizeof(Matrix4i));
}
