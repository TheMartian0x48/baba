...
f64 powd(f64 base, f64 exp);
f32 sqrtf(f32 x);
f64 sqrtd(f64 x);
f32 cbrtf(f32 x);
f64 cbrtd(f64 x);
f32 hypotf(f32 x, f32 y);
f64 hypotd(f64 x, f64 y);
...
f32 tanf(f32 rad);
f32 tand(f64 rad);
f32 arc_sinf(f32 rad);
f64 arc_sind(f64 rad);
f32 arc_cosf(f32 rad);
f64 arc_cosd(f64 rad);
f32 arc_tanf(f32 rad);
f32 arc_tand(f64 rad);
...
//***** Matrix  *****
// Eample for calilng using macros:
...
//***** Matrix 2x2 i32 *****
Matrix2i* matrix2i_make(Arena* arena);                                   // creates an identity matrix 2x2 of i32
Matrix2i* matrix2i_make_aligned(Arena* arena, u64 alignment);            // creates an identity matrix 2x2 of i32
void      matrix2i_kill(Arena* arena, Matrix2i* matrix);                 // creates an identity matrix 2x2 of i32
...
void      matrix2i_add(Matrix2i* a, Matrix2i* b);                        // add matrix b to matrix a
void      matrix2i_subtract(Matrix2i* a, Matrix2i* b);                   // substract matrix b from matrix a
void      matrix2i_scale(Matrix2i* a, i32 s);                            // scale matrix a by scaler s
void      matrix2i_multiply(Matrix2i* a, Matrix2i* b, Matrix2i* result); // result = a * b
void      matrix2i_copy(Matrix2i* a, Matrix2i* result);                  // copy matrix a
void      matrix2i_transpose(Matrix2i* a);                               // transposition of matrix a
void      matrix2i_print(Matrix2i* a, FILE* stream);                     // print matrix a

//***** Matrix 2x2 f32 *****
Matrix2f* matrix2f_make(Arena* arena);                                   // creates an identity matrix 2x2 of i32
Matrix2f* matrix2f_make_aligned(Arena* arena, u64 alignment);            // creates an identity matrix 2x2 of i32
void      matrix2f_kill(Arena* arena, Matrix2f* matrix);                 // creates an identity matrix 2x2 of i32
...
void      matrix2f_add(Matrix2f* a, Matrix2f* b);                        // add matrix b to matrix a
void      matrix2f_subtract(Matrix2f* a, Matrix2f* b);                   // substract matrix b from matrix a
void      matrix2f_scale(Matrix2f* a, f32 s);                            // scale matrix a by scaler s
void      matrix2f_multiply(Matrix2f* a, Matrix2f* b, Matrix2f* result); // result = a * b
void      matrix2f_copy(Matrix2f* a, Matrix2f* result);                  // copy matrix a
void      matrix2f_print(Matrix2f* a, FILE* stream);                     // print matrix a

//***** Matrix 3x3 i32 *****
Matrix3i* matrix3i_make(Arena* arena);                                   // creates an identity matrix 2x2 of i32
Matrix3i* matrix3i_make_aligned(Arena* arena, u64 alignment);            // creates an identity matrix 2x2 of i32
void      matrix3i_kill(Arena* arena, Matrix3i* matrix);                 // creates an identity matrix 2x2 of i32
...
void      matrix3i_add(Matrix3i* a, Matrix3i* b);                        // add matrix b to matrix a
void      matrix3i_subtract(Matrix3i* a, Matrix3i* b);                   // substract matrix b from matrix a
void      matrix3i_scale(Matrix3i* a, i32 s);                            // scale matrix a by scaler s
void      matrix3i_multiply(Matrix3i* a, Matrix3i* b, Matrix3i* result); // result = a * b
void      matrix3i_copy(Matrix3i* a, Matrix3i* result);                  // copy matrix a
void      matrix3i_print(Matrix3i* a, FILE* stream);                     // print matrix a

//***** Matrix 3x3 f32 *****
Matrix3f* matrix3f_make(Arena* arena);                                   // creates an identity matrix 2x2 of i32
Matrix3f* matrix3f_make_aligned(Arena* arena, u64 alignment);            // creates an identity matrix 2x2 of i32
void      matrix3f_kill(Arena* arena, Matrix3f* matrix);                 // creates an identity matrix 2x2 of i32
...
void      matrix3f_add(Matrix3f* a, Matrix3f* b);                        // add matrix b to matrix a
void      matrix3f_subtract(Matrix3f* a, Matrix3f* b);                   // substract matrix b from matrix a
void      matrix3f_scale(Matrix3f* a, f32 s);                            // scale matrix a by scaler s
void      matrix3f_multiply(Matrix3f* a, Matrix3f* b, Matrix3f* result); // result = a * b
void      matrix3f_copy(Matrix3f* a, Matrix3f* result);                  // copy matrix a
void      matrix3f_print(Matrix3f* a, FILE* stream);                     // print matrix a

//***** Matrix 4x4 i32 *****
Matrix4i* matrix4i_make(Arena* arena);                                   // creates an identity matrix 2x2 of i32
Matrix4i* matrix4i_make_aligned(Arena* arena, u64 alignment);            // creates an identity matrix 2x2 of i32
void      matrix4i_kill(Arena* arena, Matrix4i* matrix);                 // creates an identity matrix 2x2 of i32
...
void      matrix4i_add(Matrix4i* a, Matrix4i* b);                        // add matrix b to matrix a
void      matrix4i_subtract(Matrix4i* a, Matrix4i* b);                   // substract matrix b from matrix a
void      matrix4i_scale(Matrix4i* a, i32 s);                            // scale matrix a by scaler s
void      matrix4i_multiply(Matrix4i* a, Matrix4i* b, Matrix4i* result); // result = a * b
void      matrix4i_copy(Matrix4i* a, Matrix4i* result);                  // copy matrix a
void      matrix4i_print(Matrix4i* a, FILE* stream);                     // print matrix a

//***** Matrix 4x4 f32 *****
Matrix4f* matrix4f_make(Arena* arena);                                   // creates an identity matrix 2x2 of i32
Matrix4f* matrix4f_make_aligned(Arena* arena, u64 alignment);            // creates an identity matrix 2x2 of i32
void      matrix4f_kill(Arena* arena, Matrix4f* matrix);                 // creates an identity matrix 2x2 of i32
...
void      matrix4f_add(Matrix4f* a, Matrix4f* b);                        // add matrix b to matrix a
void      matrix4f_subtract(Matrix4f* a, Matrix4f* b);                   // substract matrix b from matrix a
void      matrix4f_scale(Matrix4f* a, f32 s);                            // scale matrix a by scaler s
void      matrix4f_multiply(Matrix4f* a, Matrix4f* b, Matrix4f* result); // result = a * b
void      matrix4f_copy(Matrix4f* a, Matrix4f* result);                  // copy matrix a
void      matrix4f_print(Matrix4f* a, FILE* stream);                     // print matrix a
